...
void main () {
  ...
  char string[100] = "dcdevs", *p_string=&string;

  // Imprimindo as variaveis antes dos valores serem modificados com o ponteiro
  ...
  // Imprimindo as variaveis após os valores serem modificados com o ponteiro
